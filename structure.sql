...
--
-- Host: 127.0.0.1    Database: lendy_development
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_times_borrowed AFTER INSERT ON reservations
...
--
-- Dumping events for database 'lendy_development'
--

--
-- Dumping routines for database 'lendy_development'
--
/*!50003 DROP PROCEDURE IF EXISTS `get_number_item_type` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_number_item_type`(IN i_type CHAR(50))
SELECT
    COUNT(items.id)
  FROM
    items, item_types
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_number_students` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_number_students`(IN sch CHAR(50))
SELECT
    COUNT(users.id)
  FROM
    users,
...
-- Dump completed on 2017-04-21  3:08:32
